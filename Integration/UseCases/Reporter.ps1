Describe "Automatically Informs Users" {
    ...
    Describe "Notifications" {
        It "Sends Overbudget Notification" -Tags "RPT-NFY-01","v0.5.0" {
            $target = 20
        ...
        It "Sends Budget Met Notification" -Tags "RPT-NFY-02","v0.5.0" {
            $target = 20
        ...
        It "Sends Bounced Notification" -Tags "RPT-NFY-03","vB.3.0" {
        ...
        It "Sends Below Threshold Notification" -Tags "RPT-NFY-04","v0.5.1" {
        ...
        It "Sends Above Threshold Notification" -Tags "RPT-NFY-05","v0.5.1" {
            Add-BankAccount -Name "NotificationAccount" -BankName "MyBank" -Number 1234560 -Currency CanadianDollar
            $target = Get-BankAccount NotificationAccount | ForEach-Object CurrentFunds
